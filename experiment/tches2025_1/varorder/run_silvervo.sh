...
do
	...
	echo "" >> experiment/tches2025_1/varorder/silver_vo0.csv
...
do
	...
	echo "" >> experiment/tches2025_1/varorder/silver_vo1.csv
...
do
	...
	echo "" >> experiment/tches2025_1/varorder/silver_vo2.csv
